        ...
        if (student_select == "1"):
            ...
            while True:
                ...
                if (one_select == "전공"):
                    ...
                    f1.close()
                    print("--------------------------------------------------------------------------------")
                    print("메뉴로 돌아가려면 엔터 키를 입력하시오", end = "")
                    input()
            ...
            while True:
                ...
                isSubNumberEx = isSubNumberExists(student_select_sub, subFileLines)
...
def isSubNumberExists(student_select_sub, subFileLines):
    ...
    for line in subFileLines:
        elementsOfLine = line.strip().split('    ')
        subNums.append(elementsOfLine[0])

    if student_select_sub not in subNums:
